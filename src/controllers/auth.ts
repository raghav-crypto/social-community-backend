...
export async function login(req: Request, res: Response, next: NextFunction) {
    passport.authenticate('local', function (err: Error, user: SocialTypes.UserData, info: { message: string }) {
...
export async function googleCallback(req: Request, res: Response, next: NextFunction) {
    passport.authenticate("google", async (error: Error, user: SocialTypes.UserData, info: { message: string }) => {
        try {
...
export async function loginFailed(req: Request, res: Response, next: NextFunction) {
    return next(new ErrorResponse("Error while logging", "login", 401))
}
export async function loginSuccess(req: Request, res: Response, next: NextFunction) {
    if (req.user) {
